...
if __name__ == '__main__':
    ...
    print(dataset, ncentroid, Maxdeg, nprobe, k, " IVFHNSW")
    ...
    consparam = "IVF"+str(ncentroid)+"_HNSW"+str(Maxdeg)+",Flat"    
    ...
    filename = 'results/' + dataset +'-IVFHNSW' + '.csv'
    with open(filename, 'a') as fd:
        fd.write(str(ncentroid) + ',' + str(Maxdeg) + ',' + str(nprobe) + ','+ str(traintime) + ',' + str(qps) + ',' + str(memory_in_MB) + ',' + str(recall_score) + ',' + str(k) +'\n')